...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tiptap'), require('tiptap-commands'), require('lowlight/lib/core'), require('prosemirror-view'), require('prosemirror-utils'), require('prosemirror-state'), require('prosemirror-tables'), require('tiptap-utils'), require('prosemirror-history')) :
  typeof define === 'function' && define.amd ? define(['exports', 'tiptap', 'tiptap-commands', 'lowlight/lib/core', 'prosemirror-view', 'prosemirror-utils', 'prosemirror-state', 'prosemirror-tables', 'tiptap-utils', 'prosemirror-history'], factory) :
  (global = global || self, factory(global.tiptap = {}, global.tiptap, global.tiptapCommands, global.low, global.prosemirrorView, global.prosemirrorUtils, global.prosemirrorState, global.prosemirrorTables, global.tiptapUtils, global.prosemirrorHistory));
}(this, function (exports, tiptap, tiptapCommands, low, prosemirrorView, prosemirrorUtils, prosemirrorState, prosemirrorTables, tiptapUtils, prosemirrorHistory) { 'use strict';
  ...
  function (_Mark) {
    ...
    _createClass(Italic, [{
      ...
      value: function pasteRules(_ref4) {
        var type = _ref4.type;
        return [tiptapCommands.markPasteRule(/(?:^|[^*_])(?:\*|_)([^*_]+)(?:\*|_)/g, type)];
      }
    }, {
      key: "name",
      get: function get() {
